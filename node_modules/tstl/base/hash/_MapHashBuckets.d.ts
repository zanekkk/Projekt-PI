 ...
 * @hidden
 */
export declare class _MapHashBuckets<Key, T, Unique extends boolean, Source extends IHashMap<Key, T, Unique, Source>> extends _HashBuckets<MapIterator<Key, T, Unique, Source>> {
    private source_;
    ...
    find(key: Key): MapIterator<Key, T, Unique, Source>;
    hash_index(it: MapIterator<Key, T, Unique, Source>): number;
}
