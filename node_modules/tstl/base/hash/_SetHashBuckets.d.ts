 ...
 * @hidden
 */
export declare class _SetHashBuckets<T, Unique extends boolean, Source extends IHashSet<T, Unique, Source>> extends _HashBuckets<SetIterator<T, Unique, Source>> {
    private source_;
    ...
    find(val: T): SetIterator<T, Unique, Source>;
    hash_index(it: SetIterator<T, Unique, Source>): number;
}
