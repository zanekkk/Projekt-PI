 ...
 */
export declare abstract class UniqueMap<Key, T, Source extends UniqueMap<Key, T, Source>> extends MapContainer<Key, T, true, Source> {
    /**
     * @inheritDoc
     */
     ...
     */
    abstract emplace(key: Key, value: T): Pair<MapIterator<Key, T, true, Source>, boolean>;
    /**
     ...
     */
    abstract emplace_hint(hint: MapIterator<Key, T, true, Source>, key: Key, val: T): MapIterator<Key, T, true, Source>;
    /**
     * Insert an element.
     *
     ...
     * @return {@link Pair} of an iterator to the newly inserted element and `true`, if the specified *key* doesn't exist, otherwise {@link Pair} of iterator to the ordinary element and `false`.
     */
    insert(pair: IPair<Key, T>): Pair<MapIterator<Key, T, true, Source>, boolean>;
    /**
     ...
     * @return An iterator to the newly inserted element, if the specified key doesn't exist, otherwise an iterator to the ordinary element.
     */
    insert(hint: MapIterator<Key, T, true, Source>, pair: IPair<Key, T>): MapIterator<Key, T, true, Source>;
    /**
     ...
     * @return {@link Pair} of an iterator to the newly inserted element and `true`, if the specified *key* doesn't exist, otherwise {@link Pair} of iterator to the ordinary element and `false`.
     */
    insert_or_assign(key: Key, value: T): Pair<MapIterator<Key, T, true, Source>, boolean>;
    /**
     ...
     * @return {@link Pair} of an iterator to the newly inserted element and `true`, if the specified *key* doesn't exist, otherwise {@link Pair} of iterator to the ordinary element and `false`.
     */
    insert_or_assign(hint: MapIterator<Key, T, true, Source>, key: Key, value: T): MapIterator<Key, T, true, Source>;
    /**
     * @hidden
     */
     ...
     */
    extract(pos: MapIterator<Key, T, true, Source>): MapIterator<Key, T, true, Source>;
    /**
     * @hidden
     */
