 ...
 * @hidden
 */
export declare function _Construct<Key, T extends Elem, SourceT extends _ITreeContainer<Key, T, SourceT, IteratorT, ReverseIteratorT, Elem>, IteratorT extends Iterator<T, SourceT, IteratorT, ReverseIteratorT, Elem>, ReverseIteratorT extends ReverseIterator<T, SourceT, IteratorT, ReverseIteratorT, Elem>, Elem>(source: SourceT, Source: _Factory<SourceT>, treeFactory: (comp: (x: Key, y: Key) => boolean) => void, ...args: any[]): void;
/**
 * @hidden
 */
export declare function _Emplace_hint<Key, T extends Elem, SourceT extends _ITreeContainer<Key, T, SourceT, IteratorT, ReverseIteratorT, Elem>, IteratorT extends Iterator<T, SourceT, IteratorT, ReverseIteratorT, Elem>, ReverseIteratorT extends ReverseIterator<T, SourceT, IteratorT, ReverseIteratorT, Elem>, Elem>(source: SourceT, hint: IteratorT, elem: T, data: IData<T, IteratorT>, handleInsert: (first: IteratorT, last: IteratorT) => void, breaker: () => IteratorT): IteratorT;
/**
 * @hidden
 */
