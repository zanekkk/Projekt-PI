 ...
 */
export declare function begin<Iterator extends IForwardIterator<IPointer.ValueType<Iterator>, Iterator>>(container: IForwardContainer<Iterator>): Iterator;
/**
 * @hidden
 */
 ...
 */
export declare function end<Iterator extends IForwardIterator<IPointer.ValueType<Iterator>, Iterator>>(container: IForwardContainer<Iterator>): Iterator;
/**
 * @hidden
 */
 ...
 */
export declare function inserter<Container extends _IInsert<Iterator>, Iterator extends IForwardIterator<IPointer.ValueType<Iterator>, Iterator>>(container: Container, it: Iterator): InsertIterator<Container, Iterator>;
/**
 * @hidden
 */
export declare function inserter<T>(container: Array<T>, it: Vector.Iterator<T>): InsertIterator<Vector<T>, Vector.Iterator<T>>;
/**
 ...
 */
export declare function rbegin<Iterator extends IReversableIterator<IPointer.ValueType<Iterator>, Iterator, ReverseIterator>, ReverseIterator extends IReverseIterator<IPointer.ValueType<Iterator>, Iterator, ReverseIterator>>(container: IBidirectionalContainer<Iterator, ReverseIterator>): ReverseIterator;
/**
 * @hidden
 */
 ...
 */
export declare function rend<Iterator extends IReversableIterator<IPointer.ValueType<Iterator>, Iterator, ReverseIterator>, ReverseIterator extends IReverseIterator<IPointer.ValueType<Iterator>, Iterator, ReverseIterator>>(container: IBidirectionalContainer<Iterator, ReverseIterator>): ReverseIterator;
/**
 * @hidden
 */
