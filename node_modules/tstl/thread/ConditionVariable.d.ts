 ...
 * @hidden
 */
declare type Predicator = () => boolean | Promise<boolean>;
export declare type condition_variable = ConditionVariable;
export declare const condition_variable: typeof ConditionVariable;
export {};
