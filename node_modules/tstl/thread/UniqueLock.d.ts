...
export declare namespace UniqueLock {
    ...
    function try_lock_for<Mutex extends Pick<ITimedLockable, "try_lock_for" | "unlock">>(mutex: Mutex, ms: number, closure: Closure): Promise<boolean>;
    function try_lock_until<Mutex extends Pick<ITimedLockable, "try_lock_until" | "unlock">>(mutex: Mutex, at: Date, closure: Closure): Promise<boolean>;
}
export import unique_lock = UniqueLock;
/**
 * @hidden
 */
declare type IMutex = ILockable & Partial<ITimedLockable>;
/**
 * @hidden
 */
