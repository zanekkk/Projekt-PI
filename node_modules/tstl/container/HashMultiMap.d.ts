 ...
 */
export declare class HashMultiMap<Key, T> extends MultiMap<Key, T, HashMultiMap<Key, T>> implements IHashMap<Key, T, false, HashMultiMap<Key, T>> {
    /**
     * @hidden
     */
    private buckets_;
...
export declare namespace HashMultiMap {
    type Iterator<Key, T> = MapIterator<Key, T, false, HashMultiMap<Key, T>>;
    type ReverseIterator<Key, T> = MapReverseIterator<Key, T, false, HashMultiMap<Key, T>>;
