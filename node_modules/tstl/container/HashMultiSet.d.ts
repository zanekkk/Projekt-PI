 ...
 */
export declare class HashMultiSet<Key> extends MultiSet<Key, HashMultiSet<Key>> implements IHashSet<Key, false, HashMultiSet<Key>> {
    /**
     * @hidden
     */
    private buckets_;
...
export declare namespace HashMultiSet {
    type Iterator<Key> = SetIterator<Key, false, HashMultiSet<Key>>;
    type ReverseIterator<Key> = SetReverseIterator<Key, false, HashMultiSet<Key>>;
