 ...
 */
export declare class HashMap<Key, T> extends UniqueMap<Key, T, HashMap<Key, T>> implements IHashMap<Key, T, true, HashMap<Key, T>> {
    /**
     * @hidden
     */
    private buckets_;
...
export declare namespace HashMap {
    type Iterator<Key, T> = MapIterator<Key, T, true, HashMap<Key, T>>;
    type ReverseIterator<Key, T> = MapReverseIterator<Key, T, true, HashMap<Key, T>>;
