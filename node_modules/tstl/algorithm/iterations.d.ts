 ...
 */
export declare function all_of<InputIterator extends Readonly<IForwardIterator<IPointer.ValueType<InputIterator>, InputIterator>>>(first: InputIterator, last: InputIterator, pred: (val: IPointer.ValueType<InputIterator>) => boolean): boolean;
/**
 ...
 */
export declare function any_of<InputIterator extends Readonly<IForwardIterator<IPointer.ValueType<InputIterator>, InputIterator>>>(first: InputIterator, last: InputIterator, pred: (val: IPointer.ValueType<InputIterator>) => boolean): boolean;
/**
 ...
 */
export declare function none_of<InputIterator extends Readonly<IForwardIterator<IPointer.ValueType<InputIterator>, InputIterator>>>(first: InputIterator, last: InputIterator, pred: (val: IPointer.ValueType<InputIterator>) => boolean): boolean;
/**
 ...
 * @return Whether two ranges are equal.
 */
export declare function equal<InputIterator1 extends Readonly<IForwardIterator<IPointer.ValueType<InputIterator1>, InputIterator1>>, InputIterator2 extends Readonly<IForwardIterator<IPointer.ValueType<InputIterator2>, InputIterator2>>>(first1: InputIterator1, last1: InputIterator1, first2: InputIterator2, pred: (x: IPointer.ValueType<InputIterator1>, y: IPointer.ValueType<InputIterator2>) => boolean): boolean;
/**
 ...
 */
export declare function lexicographical_compare<Iterator1 extends Readonly<IForwardIterator<IPointer.ValueType<Iterator1>, Iterator1>>, Iterator2 extends Readonly<IForwardIterator<IPointer.ValueType<Iterator1>, Iterator2>>>(first1: Iterator1, last1: Iterator1, first2: Iterator2, last2: Iterator2, comp?: (x: IPointer.ValueType<Iterator1>, y: IPointer.ValueType<Iterator1>) => boolean): boolean;
/**
 ...
 */
export declare function find_if<InputIterator extends Readonly<IForwardIterator<IPointer.ValueType<InputIterator>, InputIterator>>>(first: InputIterator, last: InputIterator, pred: (val: IPointer.ValueType<InputIterator>) => boolean): InputIterator;
/**
 ...
 */
export declare function find_if_not<InputIterator extends Readonly<IForwardIterator<IPointer.ValueType<InputIterator>, InputIterator>>>(first: InputIterator, last: InputIterator, pred: (val: IPointer.ValueType<InputIterator>) => boolean): InputIterator;
/**
 ...
 * @return Iterator to the first element of the last sub range.
 */
export declare function find_end<Iterator1 extends Readonly<IForwardIterator<IPointer.ValueType<Iterator1>, Iterator1>>, Iterator2 extends Readonly<IForwardIterator<IPointer.ValueType<Iterator2>, Iterator2>>>(first1: Iterator1, last1: Iterator1, first2: Iterator2, last2: Iterator2, pred: (x: IPointer.ValueType<Iterator1>, y: IPointer.ValueType<Iterator2>) => boolean): Iterator1;
/**
 ...
 */
export declare function adjacent_find<InputIterator extends Readonly<IForwardIterator<IPointer.ValueType<InputIterator>, InputIterator>>>(first: InputIterator, last: InputIterator, pred?: (x: IPointer.ValueType<InputIterator>, y: IPointer.ValueType<InputIterator>) => boolean): InputIterator;
/**
 * Search sub range.
 *
 ...
 * @return A {@link Pair} of mismatched positions.
 */
export declare function mismatch<Iterator1 extends Readonly<IForwardIterator<IPointer.ValueType<Iterator1>, Iterator1>>, Iterator2 extends Readonly<IForwardIterator<IPointer.ValueType<Iterator2>, Iterator2>>>(first1: Iterator1, last1: Iterator1, first2: Iterator2, pred: (x: IPointer.ValueType<Iterator1>, y: IPointer.ValueType<Iterator2>) => boolean): Pair<Iterator1, Iterator2>;
/**
 ...
 * @return The matched count.
 */
export declare function count_if<InputIterator extends Readonly<IForwardIterator<IPointer.ValueType<InputIterator>, InputIterator>>>(first: InputIterator, last: InputIterator, pred: (val: IPointer.ValueType<InputIterator>) => boolean): number;
