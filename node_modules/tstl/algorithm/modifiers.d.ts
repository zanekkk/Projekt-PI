 ...
 * @return Output Iterator of the last position by advancing.
 */
export declare function transform<InputIterator extends Readonly<IForwardIterator<IPointer.ValueType<InputIterator>, InputIterator>>, OutputIterator extends Writeonly<IForwardIterator<IPointer.ValueType<OutputIterator>, OutputIterator>>>(first: InputIterator, last: InputIterator, result: OutputIterator, op: (val: IPointer.ValueType<InputIterator>) => IPointer.ValueType<OutputIterator>): OutputIterator;
/**
 * Transform elements.
 *
 ...
 * @return Output Iterator of the last position by advancing.
 */
export declare function transform<InputIterator1 extends Readonly<IForwardIterator<IPointer.ValueType<InputIterator1>, InputIterator1>>, InputIterator2 extends Readonly<IForwardIterator<IPointer.ValueType<InputIterator2>, InputIterator2>>, OutputIterator extends Writeonly<IForwardIterator<IPointer.ValueType<OutputIterator>, OutputIterator>>>(first1: InputIterator1, last1: InputIterator1, first2: InputIterator2, result: OutputIterator, binary_op: (x: IPointer.ValueType<InputIterator1>, y: IPointer.ValueType<InputIterator2>) => IPointer.ValueType<OutputIterator>): OutputIterator;
/**
 ...
 */
export declare function unique<InputIterator extends General<IForwardIterator<IPointer.ValueType<InputIterator>, InputIterator>>>(first: InputIterator, last: InputIterator, pred?: (x: IPointer.ValueType<InputIterator>, y: IPointer.ValueType<InputIterator>) => boolean): InputIterator;
/**
 ...
 * @return Output Iterator of the last position by advancing.
 */
export declare function unique_copy<InputIterator extends Readonly<IForwardIterator<IPointer.ValueType<InputIterator>, InputIterator>>, OutputIterator extends Writeonly<IForwardIterator<IPointer.ValueType<InputIterator>, OutputIterator>>>(first: InputIterator, last: InputIterator, output: OutputIterator, pred?: (x: IPointer.ValueType<InputIterator>, y: IPointer.ValueType<InputIterator>) => boolean): OutputIterator;
/**
 ...
 * @return Iterator tho the last element not removed.
 */
export declare function remove_if<InputIterator extends General<IForwardIterator<IPointer.ValueType<InputIterator>, InputIterator>>>(first: InputIterator, last: InputIterator, pred: (val: IPointer.ValueType<InputIterator>) => boolean): InputIterator;
/**
 ...
 * @param new_val Specific value to be changed.
 */
export declare function replace_if<InputIterator extends General<IForwardIterator<IPointer.ValueType<InputIterator>, InputIterator>>>(first: InputIterator, last: InputIterator, pred: (val: IPointer.ValueType<InputIterator>) => boolean, new_val: IPointer.ValueType<InputIterator>): void;
/**
 ...
 * @return Output Iterator of the last position by advancing.
 */
export declare function replace_copy_if<InputIterator extends Readonly<IForwardIterator<IPointer.ValueType<InputIterator>, InputIterator>>, OutputIterator extends Writeonly<IForwardIterator<IPointer.ValueType<InputIterator>, OutputIterator>>>(first: InputIterator, last: InputIterator, result: OutputIterator, pred: (val: IPointer.ValueType<InputIterator>) => boolean, new_val: IPointer.ValueType<InputIterator>): OutputIterator;
/**
