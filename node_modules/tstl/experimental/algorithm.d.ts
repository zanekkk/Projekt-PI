 ...
 */
export declare function erase<Container extends IContainer<Iterator>, Iterator extends Readonly<IForwardIterator<IPointer.ValueType<Iterator>, Iterator>>>(container: Container, val: IPointer.ValueType<Iterator>): void;
 ...
 */
export declare function erase_if<Container extends IContainer<Iterator>, Iterator extends Readonly<IForwardIterator<IPointer.ValueType<Iterator>, Iterator>>>(container: Container, predicator: (val: IPointer.ValueType<Iterator>) => boolean): void;
